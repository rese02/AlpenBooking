...
function HotelDashboardLayoutContent({
  children
}: {
...
export default function HotelDashboardLayout({
  ...
  return (
    <ProtectedRoute requiredRole="hotelier" requiredHotelId={hotelId} loginPath={`/hotelier-login?hotelId=${hotelId}`}>
      <HotelDashboardLayoutContent>{children}</HotelDashboardLayoutContent>
    </ProtectedRoute>
  );
}
